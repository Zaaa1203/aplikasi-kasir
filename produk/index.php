...
<div class="container">
	<div class="row">
			<div class="col-sm-8"><h3>Daftar Produk</h3></div>
			<div class="col-sm-4">
    ...
    <datalist id="productNames">
        ...
        include "../config.php";
        $sqlp = "SELECT nama_produk FROM produk";
        $resp = mysqli_query($koneksi, $sqlp);
        while ($dtp = mysqli_fetch_array($resp)) {
        ?>
            <option value="<?= $dtp['nama_produk'] ?>"></option>
        <?php
        }
        ?>
    </datalist>
			...
			<td colspan="6" class="text-center">
				<div class="container">
					<div class="row">
						...
						<!-- tombol input	 -->
							<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#myModal">[+] Data Produk</button>
							<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tambahstok">[+] Stok</button>				
						</div>
